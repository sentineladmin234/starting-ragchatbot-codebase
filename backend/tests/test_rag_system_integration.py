...
class TestRAGSystemIntegration(unittest.TestCase):
    ...
    def test_query_flow_with_mocked_ai(self, mock_anthropic_class):
        ...
        mock_client = Mock()
        mock_response = Mock()
        mock_response.content = [Mock(text="Machine learning is a subset of AI that focuses on algorithms.")]
    ...
    def test_query_with_tool_use_mocked(self, mock_anthropic_class):
        ...
        mock_final_response.content = [Mock(text="Based on course materials, machine learning involves...")]
        ...
        response, sources = rag_system.query("Tell me about machine learning from the courses")
